...
FusionCharts.register('theme', {
  ...
  theme: {
    ...
    column2d: { chart: { showValues: '1', paletteColors: '#36B5D8' } },
    column3d: { chart: { paletteColors: '#36B5D8', canvasBaseDepth: '2', canvasBaseColor: '#4D5058' } },
    line: {
      chart: {
    ...
    area2d: { chart: { drawAnchors: '0', paletteColors: '#36B5D8', drawCrossLine: '1', plotFillAlpha: '85' } },
    bar2d: { chart: { showValues: '1', paletteColors: '#36B5D8' } },
    bar3d: { chart: { paletteColors: '#36B5D8', canvasBaseDepth: '2', canvasBaseColor: '#4D5058' } },
    pie2d: {
      chart: {
        showZeroPies: '1',
        use3DLighting: '0',
    ...
    mscolumn2d: { chart: { drawCrossLine: '1', showLegend: '1', legendIconSides: '4' } },
    mscolumn3d: { chart: { showLegend: '1', legendIconSides: '4', canvasBaseDepth: '2', canvasBaseColor: '#4D5058' } },
    msline: {
      chart: {
        showLegend: '1',
        legendIconSides: '2',
    ...
    msbar2d: { chart: { drawCrossLine: '1', showLegend: '1', legendIconSides: '4' } },
    msbar3d: { chart: { showLegend: '1', legendIconSides: '4', canvasBaseDepth: '2', canvasBaseColor: '#4D5058' } },
    msarea: { chart: { showLegend: '1', legendIconSides: '4', plotFillAlpha: '70', drawCrossLine: '1' } },
    marimekko: {
      chart: {
        showLegend: '1',
        legendIconSides: '4',
    ...
    stackedcolumn2d: { chart: { showLegend: '1', legendIconSides: '4', drawCrossLine: '1' } },
    stackedcolumn3d: {
      chart: { showLegend: '1', legendIconSides: '4', canvasBaseDepth: '2', canvasBaseColor: '#4D5058' }
    },
    stackedbar2d: { chart: { showLegend: '1', legendIconSides: '4', drawCrossLine: '1' } },
    stackedbar3d: {
      chart: { showLegend: '1', legendIconSides: '4', canvasBaseDepth: '2', canvasBaseColor: '#4D5058' }
    },
    stackedarea2d: { chart: { showLegend: '1', legendIconSides: '4', plotFillAlpha: '85', drawCrossLine: '1' } },
    ...
    scatter: {
      ...
      dataset: [{ regressionLineColor: '#F6F6F6', regressionLineThickness: '1' }]
    },
    bubble: {
      chart: {
        use3DLighting: '0',
    ...
    angulargauge: {
      ...
      dials: { dial: [{ bgColor: '#F6F6F6', borderColor: '#262A33', borderThickness: '0.5' }] }
    },
    bulb: {
      chart: {
        is3D: '0',
    ...
    realtimearea: { chart: { showLegend: '1', legendIconSides: '4', plotFillAlpha: '70', showRealTimeValue: '0' } },
    realtimecolumn: { chart: { showLegend: '1', legendIconSides: '4', showRealTimeValue: '0' } },
    realtimeline: {
      chart: {
        showLegend: '1',
        legendIconSides: '2',
    ...
    realtimestackedarea: {
      chart: { showLegend: '1', legendIconSides: '4', plotFillAlpha: '85', showRealTimeValue: '0' }
    },
    realtimestackedcolumn: { chart: { showLegend: '1', legendIconSides: '4', showRealTimeValue: '0' } },
    realtimelinedy: {
      chart: {
        showLegend: '1',
        legendIconSides: '2',
    ...
    gantt: {
      ...
      categories: [
        {
          ...
          headerbgAlpha: '50',
          showHoverBand: '1',
          category: [{ fontcolor: '#F6F6F6', fontsize: '14', bgAlpha: '50', bgcolor: '#888A8F' }]
        }
      ],
      tasks: { showBorder: '0', showHoverEffect: '0', task: [{ color: '#36B5D8' }] },
      processes: {
        fontcolor: '#F6F6F6',
        isanimated: '0',
        bgcolor: '#888A8F',
      ...
      text: { fontcolor: '#F6F6F6', bgcolor: '#888A8F', bgAlpha: '50' },
      datatable: {
        fontcolor: '#F6F6F6',
        bgcolor: '#888A8F',
        bgAlpha: '50',
        datacolumn: [{ bgcolor: '#888A8F', bgAlpha: '50' }]
      },
      connectors: [{ hoverThickness: '2', connector: [{ color: '#E09653' }] }],
      milestones: { milestone: [{ color: '#6EC85A' }] }
    },
    logmscolumn2d: { chart: { drawCrossLine: '1', showLegend: '1', legendIconSides: '4' } },
    logmsline: {
      chart: {
        showLegend: '1',
        legendIconSides: '2',
    ...
    splinearea: { chart: { drawAnchors: '0', paletteColors: '#36B5D8', plotFillAlpha: '85' } },
    msspline: {
      chart: {
        showLegend: '1',
        legendIconSides: '2',
    ...
    mssplinearea: { chart: { showLegend: '1', legendIconSides: '4', plotFillAlpha: '70' } },
    errorbar2d: { chart: { showLegend: '1', legendIconSides: '4', errorBarColor: '#999CA5', errorBarThickness: '1' } },
    errorline: {
      chart: {
        showLegend: '1',
        legendIconSides: '2',
    ...
    inversemsarea: { chart: { showLegend: '1', legendIconSides: '2', plotFillAlpha: '70', drawCrossLine: '1' } },
    inversemscolumn2d: { chart: { drawCrossLine: '1', showLegend: '1', legendIconSides: '4' } },
    inversemsline: {
      chart: {
        showLegend: '1',
        legendIconSides: '2',
    ...
    dragcolumn2d: {
      ...
      dataset: [{ allowDrag: '1', data: [{ alpha: '70' }] }]
    },
    dragline: {
      chart: {
        showLegend: '1',
      ...
      categories: [{ category: [{ fontItalic: '1' }] }],
      dataset: [{ allowDrag: '1', data: [{ alpha: '70', dashed: '1' }] }]
    },
    dragarea: {
      chart: {
        showLegend: '1',
    ...
    heatmap: {
      ...
      colorrange: { gradient: '1', code: '#36B5D8' }
    },
    boxandwhisker2d: {
      chart: {
    ...
    candlestick: {
      ...
      categories: [{ verticalLineColor: '#4B4B4B', verticalLineThickness: '1', verticalLineAlpha: '50' }],
      trendlines: [{ line: [{ color: '#F6F6F6' }] }],
      vTRendlines: [{ line: [{ color: '#F6F6F6' }] }]
    },
    dragnode: {
      chart: {
        use3DLighting: '0',
      ...
      dataset: [{ color: '#36B5D8' }],
      connectors: [{ connector: [{ color: '#F0DC46', strength: '1' }] }]
    },
    msstepline: {
      chart: {
        drawAnchors: '0',
    ...
    multiaxisline: {
      ...
      axis: [{ divLineColor: '#4B4B4B', divLineAlpha: '50', setAdaptiveYMin: '1', divLineDashed: '0' }]
    },
    multilevelpie: {
      chart: {
        valueFontColor: '#F6F6F6',
      ...
      category: [{ color: '#262A33', category: [{ color: '#36B5D8', category: [{ color: '#36B5D8' }] }] }]
    },
    selectscatter: {
      chart: {
        showLegend: '1',
    ...
    overlappedcolumn2d: { chart: { drawCrossLine: '1', showLegend: '1', legendIconSides: '4' } },
    overlappedbar2d: { chart: { drawCrossLine: '1', showLegend: '1', legendIconSides: '4' } },
    scrollbar2d: {
      chart: {
        drawCrossLine: '1',
        showLegend: '1',
