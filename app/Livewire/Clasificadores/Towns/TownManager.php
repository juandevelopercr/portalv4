...
class TownManager extends BaseComponent
{
  use WithFileUploads;
  use WithPagination;
  ...
  {
    $records = Town::search($this->search, $this->filters) // Utiliza el scopeSearch para la búsqueda
      ->orderBy($this->sortBy, $this->sortDir)
      ->paginate($this->perPage);

    return view('livewire.clasificadores.towns.datatable', [
      'records' => $records,
    ]);
  }
  ...
  public function store()
  {
    ...
    try {
      ...
      $record = Town::create($validatedData);
  ...
  public function update()
  {
    ...
    try {
      ...
      $record = Town::findOrFail($recordId);
