...
namespace App\Livewire\Clasificadores\CatalogoCuentas;
...
class CatalogoCuentaManager extends BaseComponent
{
  use WithFileUploads;
  use WithPagination;
  ...
  #[Url(history: true)]
  public $sortBy = 'catalogo_cuentas.id';
  ...
  {
    $records = CatalogoCuenta::search($this->search, $this->filters) // Utiliza el scopeSearch para la búsqueda
      ->orderBy($this->sortBy, $this->sortDir)
      ->paginate($this->perPage);

    return view('livewire.clasificadores.catalogo-cuentas.datatable', [
      'records' => $records,
    ]);
  }
  ...
  {
    $rules = [
      'codigo' => 'required|string|max:20|unique:catalogo_cuentas,codigo,' . $this->recordId . ',id',
  ...
  protected function messages()
  {
    return [
      ...
      'descrip.max' => 'La descripción no debe superar los 100 caracteres.',

      'favorite.required' => 'Debe indicar si es favorito o no.',
      'favorite.integer' => 'El valor de favorito debe ser 0 o 1.',
      'favorite.in' => 'El valor de favorito debe ser 0 (no) o 1 (sí).',
    ];
  }
  ...
  public function store()
  {
    ...
    try {
      ...
      $record = CatalogoCuenta::create($validatedData);
  ...
  public function edit($recordId)
  {
    ...
    $record = CatalogoCuenta::find($recordId);
    $this->recordId = $recordId;

    $this->codigo = $record->codigo;
    $this->descrip = $record->descrip;
    $this->favorite = (int)$record->favorite;
  ...
  public function update()
  {
    ...
    try {
      ...
      $record = CatalogoCuenta::findOrFail($recordId);
  ...
  public function refresDatatable()
  {
    $config = DataTableConfig::where('user_id', Auth::id())
      ->where('datatable_name', 'classifier-catalogo-cuentas-datatable')
      ->first();
  ...
  public function getDefaultColumns()
  {
    $this->defaultColumns = [
      ...
      [
        ...
        'columnAlign' => 'center',
        'columnClass' => '',
        'function' => 'getHtmlColumnFavorite',
        'parameters' => [],
        'sumary' => '',
        'openHtmlTab' => '',
        'closeHtmlTab' => '',
  ...
  public function updatedFavorite($value)
  {
    $this->favorite = (int) $value;
  }
}
