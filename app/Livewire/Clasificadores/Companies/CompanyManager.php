...
class CompanyManager extends BaseComponent
{
  ...
  #[Url(history: true)]
  public $sortBy = 'providers_companies.id';
  ...
  public string $name = '';
  public int $commission_percentage = 0;
  public $active;
  ...
  {
    $records = ProviderCompany::search($this->search, $this->filters) // Utiliza el scopeSearch para la búsqueda
      ->orderBy($this->sortBy, $this->sortDir)
      ->paginate($this->perPage);

    return view('livewire.clasificadores.companies.datatable', [
      'records' => $records,
    ]);
  }
  ...
  {
    $rules = [
      'name' => 'required|string|max:100|unique:towns,name,' . $this->recordId . ',id',
  ...
  protected function validationAttributes()
  {
    return [
      'name' => 'nombre',
      'commission_percentage' => 'Porciento de comisión',
      'active' => 'activo',
    ];
  }
  ...
  public function store()
  {
    ...
    try {
      ...
      $record = ProviderCompany::create($validatedData);
  ...
  public function edit($recordId)
  {
    ...
    $record = ProviderCompany::find($recordId);
    $this->recordId = $recordId;

    $this->name = $record->name;
    $this->commission_percentage = $record->commission_percentage;
  ...
  public function update()
  {
    ...
    try {
      ...
      $record = ProviderCompany::findOrFail($recordId);
  ...
  public function refresDatatable()
  {
    $config = DataTableConfig::where('user_id', Auth::id())
      ->where('datatable_name', 'classifier-towns-datatable')
      ->first();
  ...
  public function getDefaultColumns()
  {
    $this->defaultColumns = [
      ...
      [
        ...
        'orderName' => 'commission_percentage',
        'label' => __('Porciento'),
        'filter' => 'filter_commission_percentage',
        'filter_type' => 'input',
        'filter_sources' => '',
        'filter_source_field' => '',
        'columnType' => 'string',
