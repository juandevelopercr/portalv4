...
class ServiceProviderManager extends BaseComponent
{
  use WithFileUploads;
  use WithPagination;
  ...
  #[Url(history: true)]
  public $sortBy = 'services_providers.id';
  ...
  {
    $records = ServiceProvider::search($this->search, $this->filters) // Utiliza el scopeSearch para la búsqueda
      ->orderBy($this->sortBy, $this->sortDir)
      ->paginate($this->perPage);

    return view('livewire.clasificadores.services-providers.datatable', [
      'records' => $records,
    ]);
  }
  ...
  public function store()
  {
    ...
    try {
      ...
      $record = ServiceProvider::create($validatedData);
  ...
  public function edit($recordId)
  {
    ...
    $record = ServiceProvider::find($recordId);
  ...
  public function update()
  {
    ...
    try {
      ...
      $record = ServiceProvider::findOrFail($recordId);
