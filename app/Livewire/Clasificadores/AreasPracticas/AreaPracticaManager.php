...
class AreaPracticaManager extends BaseComponent
{
  use WithFileUploads;
  use WithPagination;
  ...
  #[Url(history: true)]
  public $sortBy = 'areas_practicas.id';
  ...
  {
    $records = AreaPractica::search($this->search, $this->filters) // Utiliza el scopeSearch para la búsqueda
      ->orderBy($this->sortBy, $this->sortDir)
      ->paginate($this->perPage);

    return view('livewire.clasificadores.areas-practicas.datatable', [
      'records' => $records,
    ]);
  }
  ...
  public function store()
  {
    ...
    try {
      ...
      $record = AreaPractica::create($validatedData);
  ...
  public function edit($recordId)
  {
    ...
    $record = AreaPractica::find($recordId);
  ...
  public function update()
  {
    ...
    try {
      ...
      $record = AreaPractica::findOrFail($recordId);
  ...
  public function refresDatatable()
  {
    $config = DataTableConfig::where('user_id', Auth::id())
      ->where('datatable_name', 'classifier-areas-practicas-datatable')
      ->first();
