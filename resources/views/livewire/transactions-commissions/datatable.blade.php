<div>
              ...
              <div class="col-md-10">
                <div
                  ...
                  <div class="dt-buttons btn-sm btn-group flex-wrap mt-5">
                    ...
                    @if($canexport)
                      <livewire:transactions-commissions.transaction-commission-datatable-export />
                    @endif
                ...
                <table class="table table-sm mb-0 border-top table-hover dataTable no-footer" id="transaction-charge-table" style="width: 100%;">
                  ...
                  <tbody>
                    ...
                    <tr wire:key='{{ $record->id }}' class="{{ $loop->odd ? 'odd' : 'even' }}">
                      ...
                      @include('livewire.includes.columns', ['columns' => $this->columns, 'record'=>$record, 'canedit'])
  ...
  @if($action == 'create' || $action == 'edit')
    @include('livewire.transactions-commissions.partials.form')
  @endif
</div>
...
<script>
  function printTable() {
      ...
      const printContent = document.getElementById('transaction-commission-table').innerHTML;
