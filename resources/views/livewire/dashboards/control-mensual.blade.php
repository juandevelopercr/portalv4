...
<div>
    <div class="card mb-6">
      <h5 class="card-header pb-0 text-md-start text-center">{{ __('Control mensual') }}</h5>
      <div class="card-datatable text-nowrap">
        <div class="dataTables_wrapper dt-bootstrap5 no-footer">
          ...
          <div class="row mt-3 mb-6">
              @foreach (['firmas_caratulas_mes_three', 'firmas_caratulas_mes_two', 'firmas_caratulas_mes_one'] as $chartId)
                <div class="col-md-12">
