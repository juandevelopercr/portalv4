<div class="card">
  <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Reporte de viajes') }}</h4>
      ...
      <form wire:submit.prevent="exportExcel">
        <div class="row g-6">
          <div class="col-md-3 select2-primary fv-plugins-icon-container">
            ...
            <div wire:ignore>
              <select id="filter_contact" class="form-select select2-ajax" data-placeholder="Buscar cliente">
              </select>
            </div>
          </div>

          <div class="col-md-3 fv-plugins-icon-container">
            <label class="form-label" for="filter_date">{{ __('Fecha del servicio') }}</label>
          ...
          <div class="col-md-3 select2-primary fv-plugins-icon-container">
            <label class="form-label" for="filter_town">{{ __('Ciudad') }}</label>
              <div wire:ignore>
                <select wire:model="filter_town" id="filter_town" class="select2 form-select @error('filter_town') is-invalid @enderror">
          ...
          <div class="col-md-3 select2-primary fv-plugins-icon-container">
              <label class="form-label" for="filter_status">{{ __('Estado') }}</label>
                <div wire:ignore>
