<div>
  @if($action == 'list')
    ...
    <div class="card">
      <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ $this->tipo === 'PENDIENTE' ? __('Casos pendientes') : __('Casos defectuosos') }}</h4>
        ...
        <div class="dataTables_wrapper dt-bootstrap5 no-footer">
          ...
          @can("view-casos")
            <div class="card-datatable table-responsive">
              <table class="table table-sm mb-0 border-top table-hover dataTable no-footer" id="casos-situaciones-table" style="width: 100%;">
                <thead>
                  <tr>
  ...
  @if($action == 'create' || $action == 'edit')
    @include('livewire.casos.partials._form-situacion')
  @endif
</div>
...
<script>
  function printTable() {
      ...
      const printContent = document.getElementById('casos-situaciones-table').innerHTML;
