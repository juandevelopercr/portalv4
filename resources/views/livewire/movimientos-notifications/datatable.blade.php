<div>
  @if($action == 'list')
    ...
    <div class="card">
      <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Movement Notifications') }}</h4>
        ...
        <div class="dataTables_wrapper dt-bootstrap5 no-footer">
              ...
              <div
                ...
                <div class="dt-buttons btn-group flex-wrap">
                  ...
                  @can('export-movimientos')
                    <livewire:movimiento-notifications.movimiento-notification-datatable-export />
                  @endcan
                  ...
                  @livewire('components.datatable-settings', [
                    'datatableName' => 'bank-movimientos-notifications-datatable',
                    'availableColumns' => $this->columns,
                    'perPage' => $this->perPage,
                  ],
                  key('bank-movimientos-notifications-datatable-config'))
          ...
          @can("view-movimientos")
            <div class="card-datatable table-responsive">
                <table class="table table-sm mb-0 border-top table-hover dataTable no-footer" id="movimientos-notifications-table" style="width: 100%;">
                <thead>
                  <tr>
  ...
  @if($action == 'create' || $action == 'edit')
    @include('livewire.movimientos-notifications.partials.form')
  @endif
</div>
...
<script>
  function printTable() {
      ...
      const printContent = document.getElementById('movimientos-notifications-table').innerHTML;
