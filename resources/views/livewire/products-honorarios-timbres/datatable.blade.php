    ...
    <div class="card-datatable table-responsive">
      <div class="card-datatable text-nowrap">
        <div class="dataTables_wrapper dt-bootstrap5 no-footer">
            ...
            <div class="col-md-10">
              <div
                ...
                <div class="dt-buttons btn-group flex-wrap">
                  ...
                  <livewire:product-honorarios-timbres.product-honorario-timbre-datatable-export />
          ...
          <div class="card-datatable table-responsive">
            <table class="table table-sm mb-0 border-top table-hover dataTable no-footer" id="product-honorario-timbre-table" style="width: 100%;">
              <thead>
                <tr>
...
@include('livewire.products-honorarios-timbres.partials.form')
@endif
...
<script>
  function printTable() {
      ...
      const printContent = document.getElementById('product-honorario-timbre-table').innerHTML;
