<div>
  @if($action == 'list')
    ...
    <div class="card">
      <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Cuentas') }}</h4>
        ...
        <div class="dataTables_wrapper dt-bootstrap5 no-footer">
              ...
              <div
                ...
                <div class="dt-buttons btn-group flex-wrap">
                  ...
                  @livewire('components.datatable-settings', [
                    'datatableName' => 'classifier-cuentas-datatable',
                    'availableColumns' => $this->columns,
                    'perPage' => $this->perPage,
                  ],
                  key('classifier-cuentas-datatable-config'))
          ...
          @can("view-classifiers")
            <div class="card-datatable table-responsive">
                <table class="table table-sm mb-0 border-top table-hover dataTable no-footer" id="cuentas-table" style="width: 100%;">
                <thead>
                  <tr>
  ...
  @if($action == 'create' || $action == 'edit')
    @include('livewire.clasificadores.cuentas.partials.form')
  @endif
</div>
...
<script>
  (function () {
        ...
        Livewire.on('reinitCuentaControls', () => {
            console.log('Reinicializando controles después de Livewire update reinitCuentaControls');
            setTimeout(() => {
                initializeSelect2();
