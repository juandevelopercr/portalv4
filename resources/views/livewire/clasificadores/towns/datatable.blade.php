<div>
  @if($action == 'list')
    ...
    <div class="card">
      <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Ciudades') }}</h4>
        ...
        <div class="dataTables_wrapper dt-bootstrap5 no-footer">
              ...
              <div
                ...
                <div class="dt-buttons btn-group flex-wrap">
                  ...
                  @can('export-classifiers')
                    <livewire:clasificadores.towns.town-datatable-export />
                  @endcan
          ...
          @can("view-classifiers")
            <div class="card-datatable table-responsive">
                <table class="table table-sm mb-0 border-top table-hover dataTable no-footer" id="towns-table" style="width: 100%;">
                <thead>
                  <tr>
  ...
  @if($action == 'create' || $action == 'edit')
    @include('livewire.clasificadores.towns.partials.form')
  @endif
</div>
...
<script>
  function printTable() {
      ...
      const printContent = document.getElementById('towns-table').innerHTML;
