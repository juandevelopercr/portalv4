<div>
  @if($action == 'list')
    ...
    <div class="card">
      <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Timbres') }}</h4>
              ...
              <div
                ...
                <div class="dt-buttons btn-group flex-wrap">
                  ...
                  @can('export-classifiers')
                    <livewire:clasificadores.timbres.timbre-datatable-export />
                  @endcan
  ...
  @if($action == 'create' || $action == 'edit')
    @include('livewire.clasificadores.timbres.partials.form')
  @endif
</div>
