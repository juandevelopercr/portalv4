<div>
  @if($action == 'list')
    ...
    <div class="card">
      <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Áreas prácticas') }}</h4>
              ...
              <div
                ...
                <div class="dt-buttons btn-group flex-wrap">
                  ...
                  @can('export-classifiers')
                    <livewire:clasificadores.areas-practicas.area-practica-datatable-export />
                  @endcan
                  ...
                  @livewire('components.datatable-settings', [
                    'datatableName' => 'classifier-araea-practicas-datatable',
                    'availableColumns' => $this->columns,
                    'perPage' => $this->perPage,
                  ],
                  key('classifier-gareas-practicas-datatable-config'))
  ...
  @if($action == 'create' || $action == 'edit')
    @include('livewire.clasificadores.areas-practicas.partials.form')
  @endif
</div>
