<div>
  @if($action == 'list')
    ...
    <div class="card">
      <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Centros de costo') }}</h4>
              ...
              <div
                ...
                <div class="dt-buttons btn-group flex-wrap">
                  ...
                  @can('export-classifiers')
                    <livewire:clasificadores.centro-costos.centro-costo-datatable-export />
                  @endcan
                  ...
                  @livewire('components.datatable-settings', [
                    'datatableName' => 'classifier-centro-costos-datatable',
                    'availableColumns' => $this->columns,
                    'perPage' => $this->perPage,
                  ],
                  key('classifier-centro-costos-datatable-config'))
  ...
  @if($action == 'create' || $action == 'edit')
    @include('livewire.clasificadores.centro-costos.partials.form')
  @endif
</div>
...
<script>
  function printTable() {
      ...
      const printContent = document.getElementById('centro-costos-table').innerHTML;
...
<script>
  (function () {
        ...
        Livewire.on('reinitCentroCostoControls', () => {
            console.log('Reinicializando controles después de Livewire update reinitCentroCostoControls');
            setTimeout(() => {
                initializeSelect2();
