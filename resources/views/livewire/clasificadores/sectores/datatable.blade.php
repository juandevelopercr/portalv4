<div>
  @if($action == 'list')
    ...
    <div class="card">
      <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Sectores industriales') }}</h4>
              ...
              <div
                ...
                <div class="dt-buttons btn-group flex-wrap">
                  ...
                  @can('export-classifiers')
                    <livewire:clasificadores.sectores.sector-datatable-export />
                  @endcan
                  ...
                  @livewire('components.datatable-settings', [
                    'datatableName' => 'classifier-sectores-datatable',
                    'availableColumns' => $this->columns,
                    'perPage' => $this->perPage,
                  ],
                  key('classifier-sectores-datatable-config'))
  ...
  @if($action == 'create' || $action == 'edit')
    @include('livewire.clasificadores.sectores.partials.form')
  @endif
</div>
