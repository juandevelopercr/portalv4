<div>
  @if($action == 'list')
    ...
    <div class="card">
      <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Honorarios') }}</h4>
        ...
        <div class="dataTables_wrapper dt-bootstrap5 no-footer">
              ...
              <div
                ...
                <div class="dt-buttons btn-group flex-wrap">
                  ...
                  @can('export-classifiers')
                    <livewire:clasificadores.honorarios.honorario-datatable-export />
                  @endcan
                  ...
                  @livewire('components.datatable-settings', [
                    'datatableName' => 'classifier-honorarios-datatable',
                    'availableColumns' => $this->columns,
                    'perPage' => $this->perPage,
                  ],
                  key('classifier-honorarios-datatable-config'))
          ...
          @can("view-classifiers")
            <div class="card-datatable table-responsive">
              <table class="table table-sm mb-0 border-top table-hover dataTable no-footer" id="honorario-table" style="width: 100%;">
                <thead>
                  <tr>
  ...
  @if($action == 'create' || $action == 'edit')
    @include('livewire.clasificadores.honorarios.partials.form')
  @endif
</div>
...
<script>
  (function () {
        ...
        Livewire.on('reinitHonorarioControls', () => {
            console.log('Reinicializando controles después de Livewire update reinitHonorarioControls');
            setTimeout(() => {
                initializeSelect2();
