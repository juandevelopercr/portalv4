          ...
          <div class="nav-align-top nav-tabs-shadow mb-6">
            ...
            <div class="tab-content">
              <div class="tab-pane fade show @if ($this->activeTab == 'invoice') show active @endif"
                ...
                @include('livewire.transactions.partials._form-digital-credit-note')
              </div>
...
<div wire:key="digital-credit-note-customer-modal-wrapper" x-show="$wire.modalCustomerOpen" style="display:none;">
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
          @livewire('contacts.contact-manager', ['enabledSelectedValue' => true, 'type' => 'customer'], key('digital-credit-note-contact-manager-modal'))
        </div>
