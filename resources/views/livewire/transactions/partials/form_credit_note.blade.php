  ...
  <div class="col-xl">
    <div class="card mb-6">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">
          @if ($this->proforma_no)
          {{ __('Update credit note') }}: No. {{ $this->proforma_no }}
          @else
          ...
          <div class="nav-align-top nav-tabs-shadow mb-6">
            ...
            <div class="tab-content">
              <div class="tab-pane fade show @if ($this->activeTab == 'invoice') show active @endif"
                ...
                @include('livewire.transactions.partials._form-credit-note')
              </div>
              <div class="tab-pane fade @if ($this->activeTab == 'product') show active @endif"
                id="navs-justified-services" role="tabpanel">

                <div wire:key="credit-note-transaction-lines-wrapper" class="{{ $this->recordId ? '' : 'd-none' }}">
...
<div wire:key="credit-note-customer-modal-wrapper" x-show="$wire.modalCustomerOpen" style="display:none;">
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
          @livewire('contacts.contact-manager', ['enabledSelectedValue' => true, 'type' => 'customer'], key('credit-note-contact-manager-modal'))
        </div>
