  ...
  <div class="col-xl">
    <div class="card mb-6">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">
          @if ($this->proforma_no)
          {{ __('Update debit note') }}: No. {{ $this->proforma_no }}
          @else
          {{ __('Create debit note') }}
          @endif
        </h5>
          ...
          <div class="nav-align-top nav-tabs-shadow mb-6">
            ...
            <div class="tab-content">
              <div class="tab-pane fade show @if ($this->activeTab == 'invoice') show active @endif"
                ...
                @include('livewire.transactions.partials._form-digital-debit-note')
              </div>
...
<div wire:key="digital-debit-note-customer-modal-wrapper" x-show="$wire.modalCustomerOpen" style="display:none;">
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
          @livewire('contacts.contact-manager', ['enabledSelectedValue' => true, 'type' => 'customer'], key('digital-debit-note-contact-manager-modal'))
        </div>
