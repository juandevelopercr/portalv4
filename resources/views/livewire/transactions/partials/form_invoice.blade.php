                ...
                <div class="col-md-12">
                    <div class="nav-align-top nav-tabs-shadow mb-6">
                        <ul class="nav nav-tabs nav-fill" role="tablist">
                            <li class="nav-item">
                                <button type="button"
                                    class="nav-link @if ($this->activeTab == 'invoice') show active @endif" role="tab"
                            ...
                            <li class="nav-item">
                                <button type="button"
                                    class="nav-link @if ($this->activeTab == 'product') show active @endif" role="tab"
                    ...
                    */
                            ...
                            <li class="nav-item">
                                <button type="button"
                                    class="nav-link @if ($this->activeTab == 'charges') show active @endif" role="tab"
                                    wire:click="changeTab('charges')">
                                    <span class="d-none d-sm-block"><i
                                            class="tf-icons bx bx-dollar bx-lg me-1_5 align-text-center"></i>
                                        {{ __('Other Charge') }}
                                    </span>
                            ...
                            <li class="nav-item">
                                <button type="button"
                                    class="nav-link @if ($this->activeTab == 'documentos') show active @endif" role="tab"
                                    wire:click="changeTab('documentos')">
                                    <span class="d-none d-sm-block"><i
                                            class="tf-icons bx bx-file bx-lg me-1_5 align-text-center"></i>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade @if ($this->activeTab == 'documentos') show active @endif"
