...
<div>
  @if($action == 'list')
    ...
    <div class="card">
      <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Cálculos de registro') }}</h4>
      <div class="card-datatable text-nowrap">
        <div class="dataTables_wrapper dt-bootstrap5 no-footer">
              ...
              <div
                ...
                <div class="dt-buttons btn-sm btn-group flex-wrap mt-5">
                  ...
                  @livewire('components.datatable-settings', [
                    'datatableName' => 'calculo-registro-datatable',
                    'availableColumns' => $this->columns,
                    'perPage' => $this->perPage,
                  ],
                  key('calculo-registro-datatable-config'))
          ...
          @can("view-calculoregistro")
            <div class="card-datatable table-responsive">
              <table class="table table-sm mb-0 border-top table-hover dataTable no-footer" id="calculo-registro-table" style="width: 100%;">
                <thead>
                  <tr>
  ...
  @if($action == 'edit')
    @include('livewire.transactions.partials.form_calculo_registro')
  @endif
</div>
...
<script>
  function printTable() {
      ...
      const printContent = document.getElementById('calculo-registro-table').innerHTML;
