...
@section('title', __('Gráficos de Facturación por centro de costo'))
...
@push('scripts')
  ...
  <script src="{{ asset('js/facturacion-centro-costo-handler.js') }}"></script>
@endpush

@section('content')
  @livewire('dashboards.facturacion-centro-costo')
@endsection
