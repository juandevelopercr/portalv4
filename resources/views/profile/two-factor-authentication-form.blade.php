<x-action-section>
  ...
  <x-slot name="content">
    ...
    <p class="card-text">
      {{ __("When two factor authentication is enabled...") }}
    </p>
    ...
    <p class="card-text mt-2">
      @if ($showingConfirmation)
      {{ __("Scan the following QR code using your phone authenticator application and confirm") }}
      @else
      {{ __("Two factor authentication is now enabled. Scan the following QR code using your phone.") }}
      @endif
    </p>
