...
$(function () {
  ...
  const addNewForm = document.getElementById('healthsystemform');
  const actionUrl = addNewForm.action; // Accede al atributo action
  const formData = new FormData(document.getElementById('healthsystemform')); // Asegúrate que el formulario tenga el ID correcto
      ...
      success: function (response) {
        ...
        if (response.type == 'success') {
          setTimeout(function () {
            ...
            window.location.href = '/classifiers/health-systems';
