...
$(function () {
  $(document).ready(function () {
          ...
          },
          {
            ...
            render: function (data, type, full, meta) {
              ...
              if ($user_img) {
                // For Avatar image
                var $output =
                  '<img src="' + baseUrl + 'storage/assets/img/avatars/' + $user_img + '" alt="Avatar" class="rounded-circle">';
              } else {
                // For Avatar badge
          ...
          },
          {
            ...
            render: function (data, type, full, meta) {
              return (
                ...
                // Botón de editar
                `<a href="/users/${full['id']}/edit" class="btn btn-sm btn-icon edit-record">` +
        ...
        buttons: [
          ...
          },
          {
            ...
            action: function (e, dt, node, config) {
              window.location.href = '/users/create'; // Cambia '/ruta/del/formulario' por la ruta que quieras usar
            }
          }
        ],
    ...
    $(document).on('click', '.delete-record', function () {
      ...
      Swal.fire({
        ...
        if (result.value) {
          // delete the data
          $.ajax({
            url: `${baseUrl}` + `users/${user_id}`, // Asegúrate de que `baseUrl` esté correctamente definido
            type: 'DELETE',
            dataType: 'json',
    ...
    $(document).on('click', '.edit-record', function () {
      var user_id = $(this).data('id');
      window.location.href = '/edit-user/' + user_id;
    });
