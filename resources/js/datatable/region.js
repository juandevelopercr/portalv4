...
$(function () {
  $(document).ready(function () {
    ...
    var dt_table = $('.datatables-region'),
      select2 = $('.select2'),
    ...
    if (dt_table.length) {
      var dt_user = dt_table.DataTable({
        ...
        serverSide: true,
        ajax: {
          url: baseUrl + 'classifiers/regions/ajax/list'
        },
        columns: [
          ...
          },
          {
            ...
            render: function (data, type, full, meta) {
              return (
                ...
                // Botón de editar
                `<a href="/classifiers/regions/${full['id']}/edit" class="btn btn-sm btn-icon edit-record">` +
        ...
        buttons: [
          ...
          },
          {
            ...
            action: function (e, dt, node, config) {
              window.location.href = '/classifiers/regions/create'; // Cambia '/ruta/del/formulario' por la ruta que quieras usar
            }
          }
        ],
    ...
    $(document).on('click', '.delete-record', function () {
      ...
      Swal.fire({
        ...
        if (result.value) {
          // delete the data
          $.ajax({
            url: `${baseUrl}` + `classifiers/regions/${user_id}`, // Asegúrate de que `baseUrl` esté correctamente definido
            type: 'DELETE',
            dataType: 'json',
    ...
    $(document).on('click', '.edit-record', function () {
      var user_id = $(this).data('id');
      window.location.href = '/classifiers/regions/' + user_id;
    });
